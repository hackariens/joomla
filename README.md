...
![Continuous Integration](https://github.com/hackariens/joomla/actions/workflows/ci.yml/badge.svg?branch=develop)
...
```sh
git clone --recursive git@github.com:hackariens/joomla.git joomla
cd joomla
```
